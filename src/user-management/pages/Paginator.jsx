    ...
    return (
      ...
      {paginator.paginator?.totalPages == 1 ||
          <ul className="pagination">
              ...
              <li className={paginator.paginator.first ? 'page-item disabled' : 'page-item'}>
              ...
              {paginator.paginator.number == 0 ||

                  <li className="page-item">
                      <Link className="page-link" to={`${url}/${paginator.paginator.number - 1}`}>
              ...
              {paginator.paginator.number >= paginator.paginator.totalPages - 1 ||
                  <li className="page-item">
                      <Link className="page-link" to={`${url}/${paginator.paginator.number + 1}`}>
              ...
              <li className={paginator.paginator.last ? 'page-item disabled' : 'page-item'}>
                  <Link className="page-link" to={`${url}/${paginator.paginator.totalPages - 1}`}>
